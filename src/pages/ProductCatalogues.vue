<template>
  <q-page class="q-pa-sm">
    ...
    <div class="row q-col-gutter-sm ">
      <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12" v-for="item in data" :key="item.title">
...
export default defineComponent({
  ...
  components: {CardProduct: defineAsyncComponent(() => import('components/CardProduct'))},
  setup() {
    const search = ref('');
    return {
      search,
